...
// ============================================================
// MODULO "ANALISI IMPIANTI" (incorporato in questo stesso file)
// ============================================================
// Sta qui dentro per non dipendere da un secondo file: in server.js
// basta la riga require('./orari-coster')(app) e si agganciano entrambi.
const mountAnalisiCoster = (function () {
  /**
  ...
  return function mountAnalisiCoster(app) {
...
module.exports = function mountOrariCoster(app) {
  ...
  // Modulo "Analisi impianti": è in questo stesso file, si aggancia qui.
  try {
    mountAnalisiCoster(app);
  } catch (err) {
